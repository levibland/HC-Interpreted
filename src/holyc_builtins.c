...
void init_builtins(runtime_T* runtime)
{
  ...
  // GLOBAL FUNCTIONS
  runtime_register_global_function(runtime, "include", holyc_builtin_function_include);
  runtime_register_global_function(runtime, "wad", holyc_builtin_function_wad);
  runtime_register_global_function(runtime, "lad", holyc_builtin_function_lad);
  runtime_register_global_function(runtime, "print", holyc_builtin_function_print);
  runtime_register_global_function(runtime, "stdoutbuffer", holyc_builtin_function_stdoutbuffer);
  runtime_register_global_function(runtime, "aprint", holyc_builtin_function_aprint);
  runtime_register_global_function(runtime, "fopen", holyc_builtin_function_fopen);
  runtime_register_global_function(runtime, "fclose", holyc_builtin_function_fclose);
  runtime_register_global_function(runtime, "fputs", holyc_builtin_function_fputs);
  runtime_register_global_function(runtime, "input", holyc_builtin_function_input);
  runtime_register_global_function(runtime, "char_to_bin", holyc_builtin_function_char_to_bin);
  runtime_register_global_function(runtime, "char_to_oct", holyc_builtin_function_char_to_oct);
  runtime_register_global_function(runtime, "char_to_dec", holyc_builtin_function_char_to_dec);
  runtime_register_global_function(runtime, "char_to_hex", holyc_builtin_function_char_to_hex);
  runtime_register_global_function(runtime, "time", holyc_builtin_function_time);
  runtime_register_global_function(runtime, "dload", holyc_builtin_function_dload);
  runtime_register_global_function(runtime, "free", holyc_builtin_function_free);
  runtime_register_global_function(runtime, "visit", holyc_builtin_function_visit);
  runtime_register_global_function(runtime, "strrev", holyc_builtin_function_strrev);
}
 ...
 * @return AST_T*
 */
AST_T* holyc_builtin_function_print(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
...
AST_T* holyc_builtin_function_stdoutbuffer(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    for (int i = 0; i < args->size; i++)
    {
        ...
        if (str == (void*)0)
        {
            holyc_runtime_buffer_stdout(runtime, "(void*)0\n");
        }
        else
        {
            str = realloc(str, (strlen(str) + 2) * sizeof(char));
            strcat(str, "\n");
            holyc_runtime_buffer_stdout(runtime, str);
            free(str);
        }
    }
 ...
 * @return AST_T*
 */
AST_T* holyc_builtin_function_aprint(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    for (int i = 0; i < args->size; i++)
        printf("%p\n", (AST_T*) args->items[i]);
 ...
 * @return AST_T*
 */
AST_T* holyc_builtin_function_include(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    ...
    holyc_lexer_T* lexer = init_holyc_lexer(holyc_read_file(filename));
    holyc_parser_T* parser = init_holyc_parser(lexer);
    AST_T* node = holyc_parser_parse(parser, (void*) 0);

    holyc_lexer_free(lexer);
 ...
 * @return AST_T*
 */
AST_T* holyc_builtin_function_wad(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
 ...
 * @return AST_T*
 */
AST_T* holyc_builtin_function_lad(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    runtime_expect_args(args, 1, (int[]) {AST_STRING});
 ...
 * @return AST_T*
 */
AST_T* holyc_builtin_function_fopen(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
 ...
 * @return AST_T*
 */
AST_T* holyc_builtin_function_fclose(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
 ...
 * @return AST_T*
 */
AST_T* holyc_builtin_function_fputs(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
 ...
 * @return AST_T*
 */
AST_T* holyc_builtin_function_input(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    char* str;
    int c;
    int i;
...
AST_T* holyc_builtin_function_char_to_bin(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    ...
    for (int i = 8; i >= 0; i--)
    {
        ...
        char* str = holyc_char_to_string(charv);
        strcat(output, str);
    }
...
AST_T* holyc_builtin_function_char_to_oct(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    runtime_expect_args(args, 1, (int[]) {AST_CHAR});
...
AST_T* holyc_builtin_function_char_to_dec(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    runtime_expect_args(args, 1, (int[]) {AST_CHAR});
...
AST_T* holyc_builtin_function_char_to_hex(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    runtime_expect_args(args, 1, (int[]) {AST_CHAR});
...
AST_T* holyc_builtin_function_time(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    AST_T* ast_obj = init_ast(AST_OBJECT);
    ast_obj->variable_type = init_ast(AST_TYPE);
    ast_obj->variable_type->type_value = init_data_type_as(DATA_TYPE_OBJECT);
    ...
    ast_var->variable_name = holyc_init_str("seconds");
...
AST_T* holyc_builtin_function_dload(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    holyc_scope_T* scope = get_scope(runtime, self);
    ...
    for (int i = 1; i < args->size; i++)
    {
        ...
        fdef->scope = (struct holyc_scope_T*) scope;
...
AST_T* holyc_builtin_function_free(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    holyc_scope_T* scope = get_scope(runtime, self);
...
AST_T* holyc_builtin_function_visit(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    AST_T* arg = (void*)0;
...
AST_T* holyc_builtin_function_strrev(runtime_T* runtime, AST_T* self, dynamic_list_T* args)
{
    runtime_expect_args(args, 1, (int[]) {AST_STRING});

    char* input_string = ((AST_T*)args->items[0])->string_value;

    char* new_str = holyc_strrev(input_string);
